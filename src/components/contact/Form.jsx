...
const Form = () => {
  ...
  // };
  const [state, handleSubmit] = useForm("xeelwgkn");
  if (state.succeeded) {
    return <p className="text-green-500">Thanks, I'll get back to you soon!</p>;
  }
  return (
    <div>
      <p className="text-[12px] xs:text-[14px] max-lg:text-center sm:text-lg font-normal text-soft-dark">
        I'm always open to discussing work or partnership
        opportunities.
      </p>
      <div className="mx-2">
